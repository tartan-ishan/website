...
<div>
    ...
    <div style="width: 400px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/jetson_run.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/model_architecture.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Model Architecture</p>
    </div>
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/AFWM_architecture.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/dataset.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/gen_unstructured_pruning_decoder.jpg" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Generative Model Outputs after Unstructured Pruning of Decoder.</p>
    </div>  
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/gen_unstructured_pruning_encoder.jpg" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Generative Model Outputs after Unstructured Pruning of Encoder.</p>
    </div>  
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/gen_structured_pruning_decoder.jpg" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Generative Model Outputs after Structured Pruning of Decoder.</p>
    </div>  
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/gen_structured_pruning_encoder.jpg" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/AFWM_filter_pruning_MSE.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Mean Squared Error per Pruned Channel</p>
    </div>
    <div style="width: 400px; height: 200px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/AFWM_filter_pruning_SSIM.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">SSIM per Pruned Channel</p>
    </div>
    <br><br>
    ...
    <div style="width: 1000px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/distilled_gen_output_seen.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Distilled Generative Model Outputs on Seen Inputs</p>
    </div>
    <div style="width: 1000px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/distilled_gen_output_unseen.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Distilled Generative Model Outputs on Unseen Inputs</p>
    </div>
    <br><br>
    ...
    <div style="width: 1000px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/distilled_warp_compare_1.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Distilled Warping Model Outputs</p>
    </div>
        <div style="width: 1000px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/distilled_warp_compare_1.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Distilled Warping Model Outputs</p>
    ...
    <div style="width: 400px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/distililed_gen_performance.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Performance of Distilled Generative Model</p>
    </div>
    <div style="width: 400px; height: 300px; border-radius: 15px; overflow: hidden;">
        <img src="../images/on_device_ml/distilled_gen_benchmark.png" alt="Project Image" style="width: 100%; height: 100%; object-fit: cover;">
        <p style="text-align: center; margin-top: 5px; font-size: 14px;">Distilled Generative Model Benchmark (FLOPs, Param Count, Inference Latency)</p>
    </div>
</div>
